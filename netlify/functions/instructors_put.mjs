...
export default async (req) => {
  try {
    ...
    if (instructors === null || instructors === undefined || typeof instructors !== "object") {
      return json(400, { ok: false, error: "missing_instructors" });
    }
    ...
    await store.set(`instructors/${auth.centerId}`, JSON.stringify(record));

    return json(200, { ok: true, centerId: auth.centerId, updatedAt: record.updatedAt });
